document.addEventListener('DOMContentLoaded', () => {
  ...
  const i18n = {
    en: {
      ...
      neonvelocity_desc: 'Neon-themed arcade shooter game',
      link_web: 'Open Web',
      ...
      badge_new: 'NEW',
      badge_free: 'Free',
      cpsignal_desc: 'Currency strength × session no-repaint signals + auto TP/SL + live win rate',
      smccompass_desc: '30-pair SMC on a single radar — BOS/OB/FVG/Liquidity',
    ...
    ja: {
      ...
      neonvelocity_desc: 'ネオンを駆け抜けるシューティングゲーム',
      link_web: 'Webで開く',
      ...
      badge_new: 'NEW',
      badge_free: '無料',
      cpsignal_desc: '通貨強弱×セッション分析のノーリペイント売買サイン＋自動TP/SL＋勝率表示',
      smccompass_desc: '全30通貨ペアのSMCを1枚のレーダーで俯瞰 — BOS/OB/FVG/流動性',
